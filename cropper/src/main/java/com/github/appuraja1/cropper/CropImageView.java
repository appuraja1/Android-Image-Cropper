...
/**
 * Modern Custom View providing responsive cropping capabilities with zero memory leaks.
 */
public class CropImageView extends FrameLayout {
    ...
    if (intent != null) {
      ...
      if (bundle != null) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
          options = bundle.getParcelable(CropImage.CROP_IMAGE_EXTRA_OPTIONS, CropImageOptions.class);
        } else {
      ...
      if (attrs != null) {
        ...
        try {
          ...
          options.flipVertically =
                  ta.getBoolean(
                          R.styleable.CropImageView_cropFlipVertically, options.flipVertically);
  ...
  public void setImageUriAsync(Uri uri) {
    if (uri != null) {
      ...
      mCropOverlayView.setInitialCropWindowRect(null);
      BitmapLoadingWorkerTask task = new BitmapLoadingWorkerTask(this, uri);
      mBitmapLoadingWorkerTask = new WeakReference<>(task);
      task.start();
      setProgressBarVisibility();
    }
  }
  ...
  public void startCropWorkerTask(
    ...
    if (bitmap != null) {
      ...
      mBitmapCroppingWorkerTask = new WeakReference<>(task);
      task.start();
      setProgressBarVisibility();
    }
  }
  ...
  public void onRestoreInstanceState(Parcelable state) {
    if (state instanceof Bundle) {
      ...
      if (mBitmapLoadingWorkerTask == null
        ...
        Uri uri;
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
          uri = bundle.getParcelable("LOADED_IMAGE_URI", Uri.class);
        } else {
          uri = bundle.getParcelable("LOADED_IMAGE_URI");
        }
        ...
        if (uri != null) {
          ...
          if (resId > 0) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
              uri = bundle.getParcelable("LOADING_IMAGE_URI", Uri.class);
            } else {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
          initialCropRect = bundle.getParcelable("INITIAL_CROP_RECT", Rect.class);
        } else {
          initialCropRect = bundle.getParcelable("INITIAL_CROP_RECT");
        }
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
          cropWindowRect = bundle.getParcelable("CROP_WINDOW_RECT", RectF.class);
        } else {
          cropWindowRect = bundle.getParcelable("CROP_WINDOW_RECT");
        }
      ...
      if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
        superState = bundle.getParcelable("instanceState", Parcelable.class);
      } else {
        superState = bundle.getParcelable("instanceState");
      }
